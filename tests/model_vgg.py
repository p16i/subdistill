...
def test_split_vgg11_model(layer_ix):
    test_models._test_split_model("imagenet-vgg11-tv", f"features.{layer_ix}")


@pytest.mark.parametrize("layer_ix", [7, 14, 21, 28])
@pytest.mark.slow
def test_split_vgg11bn_model(layer_ix):
    test_models._test_split_model("imagenet-vgg11bn-tv", f"features.{layer_ix}")


@pytest.mark.parametrize("layer_ix", [9, 14, 19, 24])
@pytest.mark.slow
def test_split_vgg13_model(layer_ix):
    test_models._test_split_model("imagenet-vgg13-tv", f"features.{layer_ix}")


@pytest.mark.parametrize("layer_ix", [13, 20, 27, 34])
@pytest.mark.slow
def test_split_vgg13bn_model(layer_ix):
    test_models._test_split_model("imagenet-vgg13bn-tv", f"features.{layer_ix}")


@pytest.mark.parametrize("layer_ix", [9, 16, 23, 30])
@pytest.mark.slow
def test_split_vgg16_model(layer_ix):
    test_models._test_split_model("imagenet-vgg16-tv", f"features.{layer_ix}")


@pytest.mark.parametrize("layer_ix", [13, 23, 33, 43])
@pytest.mark.slow
def test_split_vgg16_model(layer_ix):
    test_models._test_split_model("imagenet-vgg16bn-tv", f"features.{layer_ix}")


@pytest.mark.parametrize("layer_ix", [9, 18, 27, 36])
@pytest.mark.slow
def test_split_vgg19_model(layer_ix):
    test_models._test_split_model("imagenet-vgg19-tv", f"features.{layer_ix}")


@pytest.mark.parametrize("layer_ix", [13, 26, 39, 54])
@pytest.mark.slow
def test_split_vgg19_model(layer_ix):
    test_models._test_split_model("imagenet-vgg19bn-tv", f"features.{layer_ix}")
