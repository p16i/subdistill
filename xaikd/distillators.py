    ...
    def _compute_loss(self, batch, prefix, batch_idx):
        ...
        for lix, policy in enumerate(self.layer_policy_collection.policies):
            ...
            if prefix == "val":
                ...
                if isinstance(parameterization_module, nn.BatchNorm2d):
                    # # here, we revert the affine transforation of batchnorm
                    standardized_values = (
                        act - parameterization_module.bias.reshape(1, -1, 1, 1)
                    ) / parameterization_module.weight.reshape(1, -1, 1, 1)
                ...
                elif isinstance(parameterization_module, nn.Conv2d):
