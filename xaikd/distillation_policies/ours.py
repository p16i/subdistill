...
@register_policy("basis-center-rotation-wo-normalize")
class OrthogonalBasisCenterRotationNoNormalizePolicy(LayerPolicy):
...
class OrthogonalBasisCenterPolicy(LayerPolicy):
...
@register_policy("basis-center-and-normalize")
class OrthogonalBasisCenterNormalizePolicy(LayerPolicy):
