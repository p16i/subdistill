...
class OrthogonalBasisRotationBiasPolicy(OrthogonalBasisCenterRotationV2Policy):
    def __init__(
        self,
        teacher_dims: int,
        student_dims: int,
...
# @register_policy("basis-center-rotationv2-scale-dim-wisev2")
# class OrthogonalBasisCenterRotationV2ScaleDimWisePolicy(LayerPolicy):
#     def __init__(
#         self,
#         teacher_dims: int,
...
#         steps = np.power(np.arange(0, k)[::-1] + 1, 2)
