...
@register_policy("basis-center-rotation--sum-normalized")
class OrthogonalBasisCenterRotationSumNormalizedPolicy(
    OrthogonalBasisCenterRotationPolicy
):
    def __init__(
        self,
        teacher_dims: int,
        ...
        super().__init__(teacher_dims, student_dims, device, basis)
