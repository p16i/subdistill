...
class OrthogonalCovEigspaceProjPolicy(LayerPolicy):
    def __init__(
        self,
        teacher_dims: int,
        student_dims: int,
...
@register_policy("basis-coveigspace")
class OrthogonalCovEigspaceProjPolicy(LayerPolicy):
    def __init__(
        self,
        teacher_dims: int,
        ...
        self.transformer_student_feats = utils.modules.CovarianceEigenspaceProjection(
            num_features=k
        ).to(device)
...
@register_policy("basis-center-with-teacher-rotation")
class OrthogonalBasisCenterWithTeacherRotationV2Policy(LayerPolicy):
    def __init__(
        self,
        teacher_dims: int,
        student_dims: int,
